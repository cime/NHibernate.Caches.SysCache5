...
namespace NHibernate.Caches.SysCache5.Configuration
{
	/// <summary>
	...
	public class SysCacheSection : ConfigurationSection
	{
		...
		private const string SectionName = "syscache5";
		...
		static SysCacheSection()
		{
			...
			var regionsProperty = new ConfigurationProperty("", typeof (CacheRegionCollection), null,
			                                                ConfigurationPropertyOptions.IsDefaultCollection);

			properties.Add(regionsProperty);
		}
